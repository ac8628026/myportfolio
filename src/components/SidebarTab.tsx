...
const SidebarTab = ({onClick,icon:Icon,title,isOpen}:SidebarTabProps) => {
  return (
    <button 
      onClick={onClick} 
      className={clsx(
    ...
    >
       <div className={clsx("flex items-center gap-4 transition-all duration-150  hover:translate-x-1")} >
