const ExperiaceCard = () => {
 const workDone = ["Reduced page load time by 60%",
    ...
    <div className="flex gap-6 relative -translate-x-8 ">
      ...
      <div className="card-glass flex flex-col min-w-52 max-w-196 grow  p-6 gap-4 w-full ">
        <div className="flex justify-between ">
          ...
          <div className=" flex h-7 items-center justify-center card-glass py-1 px-3"> 2023 - 2024 </div>
        </div>
        
        {/* small description of work at company */}
        <div>Leading development of enterprise SaaS platform. Architected microservices handling 1M+ daily requests.</div>

        {/* Points of work done */}
        <div className="flex flex-col gap-1">
           {workDone.map((pnt,index)=>{
            return (<div key={index} className="relative flex flex-row items-center gap-2">
        ...
        <div className="flex gap-1 flex-wrap">
           {skillsTech.map((tech,index)=>{return(
